...
def load_model():
    ...
    try:
        ...
        # Replace 'mnist_model.pth' with the actual path to your saved model
...
def predict_equation():
    ...
    try:
        ...
        # This is a simplified version that uses the single digit model
...
if __name__ == '__main__':
    ...
    if load_model():
        ...
        print("💡 Make sure to save your PyTorch model as 'your_model.pth'")
